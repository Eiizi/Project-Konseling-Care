...
<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <img src="{{ asset('logo.png') }}" alt="Logo Konseling" class="block h-9 w-auto">
</a>
                </div>
    ...
    {{ __('Dashboard') }}
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-dropdown-link :href="route('counselor.profile.edit')">
                    {{ __('Profile') }}
                     </x-dropdown-link>
    ...
    <x-responsive-nav-link :href="route('counselor.dashboard')" :active="request()->routeIs('counselor.dashboard')">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link :href="route('counselor.profile.edit')">
                    {{ __('Profile') }}
                </x-responsive-nav-link>
